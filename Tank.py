...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠛⠁⠀⠀⠀
	''' ,"white",attrs=["bold"])+
	 colored('                    Tool by Za ',"Yellow")+'\n\n'+
	colored(" Create By Kon Khmer !!! " , "cyan")+'\n'
)

urllib3.disable_warnings()

parser = argparse.ArgumentParser(usage="python3 Tank.py [-h --help] [--file ] [--url ] [--proxy] [--login] [--sqli] [--threads]", add_help=False)
